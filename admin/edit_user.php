					...
					<div class="col-md-8">
						...
						<form role="form" method="post">
							...
							<div class="form-group">
								...
								<input type="password" value="*******" name="user_pass" class="form-control">
							</div>
							<div class="form-group">
								<label>Nhập lại mật khẩu</label>
								<input type="password" value="*******" name="user_re_pass" class="form-control">
							</div>
							<div class="form-group">
								<label>Quyền</label>
								<select name="user_level" class="form-control">
									...
									<option <?php if ($row_user['user_level'] == 2) {
                                            echo 'selected';
